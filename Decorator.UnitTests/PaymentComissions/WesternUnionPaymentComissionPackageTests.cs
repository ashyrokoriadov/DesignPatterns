...
{
    [TestClass]
    public class WesternUnionPaymentComissionPackageTests
    {
        ...
        public void InitializeTest()
        {
            ...
            _systemUnderTests = new WesternUnionPaymentComissionPackage(_packageToBeDecorated);
        }
        ...
        public void GIVEN_Package_Decorator_WHEN_CalculatePaymentCommision_is_invoked_THEN_correct_value_is_returned()
        {
            ...
            var expected = _packageToBeDecorated.CalculatePaymentCommision() + WesternUnionPaymentComissionPackage.COMISSION;
