...
{
    [TestClass]
    public class DhlShippingPackageTests
    {
        ...
        public void InitializeTest()
        {
            ...
            _systemUnderTests = new DhlShippingPackage(_packageToBeDecorated);
        }
        ...
        public void GIVEN_Package_Decorator_WHEN_CalculateShippingCosts_is_invoked_THEN_correct_value_is_returned()
        {
            ...
            var expected = _packageToBeDecorated.CalculateShippingCosts() + DhlShippingPackage.SHIPPING_COST;
